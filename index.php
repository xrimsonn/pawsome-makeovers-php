      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          <?php if (!$usuarioIniciadoSesion) { ?>
            <li class="nav-item active"><a href="./pages/iniciarsesion.php" class="nav-link">Iniciar Sesión</a></li>
          <?php } else { ?>
            <li class="nav-item active"><a href="./pages/cuenta.php" class="nav-link">Cuenta</a></li>
          <?php } ?>
            <li class="nav-item"><a href="./pages/productos.php" class="nav-link">Productos</a></li>
            <li class="nav-item"><a href="./pages/servicios.php" class="nav-link">Servicios</a></li>
            <li class="nav-item"><a href="./pages/sobrenosotros.php" class="nav-link">Sobre nosotros</a></li>
            <li class="nav-item"><a href="./pages/contactar.php" class="nav-link">Contáctanos</a></li>
        </ul>
      </div>
  </div>
</nav>
      ...
      <div class="row">
        <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
          <div class="d-block services text-center">
            ...
            <div class="media-body">
              <h3 class="heading">Planes médicos</h3>
              <p>
                Contamos con distinto planes medico para proporcionar a nuestros clientes paquetes prácticos y economicos:
                <ol type="I">
                    <li>Plan Básico</li>
                    <li>Plan de Emergencia 24/7</li>
                    <li>Plan de Cuidado Completo para Perros y Gatos</li>
                    <li>Plan de Salud Senior para Mascotas Mayores</li>
                  </ol>
              </p>
            </div>
          </div>
        ...
        <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
          <div class="d-block services text-center">
            ...
            <div class="media-body">
              <h3 class="heading">Servicios médicos</h3>
              <p>Nos especializamos en prestar servicios médicos de alta calidad para nuestros clientes tales como:
                <ul>
        ...
        <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
          <div class="d-block services text-center">
            ...
            <div class="media-body">
              <h3 class="heading">Servicios estéticos</h3>
              <p>Tenemos distintos tratamientos y cuidado estéticos para tus mascotas  
                  <ul>
                    <li>Baño y Aseo</li>
                    <li>Corte de Pelo y Peluquería</li>
                    <li>Manicura y Pedicura</li>
                    <li>Tratamientos Antipulgas y Antigarrapatas</li>
                  </ul>
              </p>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-6 services-2 w-100 d-flex">
              ...
              <div class="text pl-3">
                ...
                <p>Mantener un cuidado constante de sus mascotas para poder prestar un servicio de calidad</p>
              </div>
            </div>
            <div class="col-md-6 services-2 w-100 d-flex">
      ...
      <div class="row" style="justify-content:space-evenly;">
        ...
        <div class="col-md-6 col-lg-3 pl-lg-5 mb-4 mb-md-0">
          ...
          <ul class="list-unstyled">
            ...
            <li><a href="./pages/productos.php" class="py-1 d-block">Productos</a></li>
            <li><a href="./pages/servicios.php" class="py-1 d-block">Servicios</a></li>
            <li><a href="./pages/sobrenosotros.php" class="py-1 d-block">Sobre nosotros</a></li>
            <li><a href="./pages/contactar.php" class="py-1 d-block">Contacto</a></li>
          </ul>
        </div>
        <div class="col-md-6 col-lg-3 mb-4 mb-md-0">
