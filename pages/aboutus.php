    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-end">
        <div class="col-md-9 ftco-animate pb-5">
          <p class="breadcrumbs mb-2"><span class="mr-2"><a href="../welcome.php">Home<i class="ion-ios-arrow-forward"></i></a></span> <span>About Us<i class="ion-ios-arrow-forward"></i></span></p>
        ...
        <div class="row d-flex no-gutters">
            ...
            <div class="col-md-7 pl-md-5 py-md-5">
                <div class="heading-section pt-md-5">
                    <h2 class="mb-4">Strategic plan</h2>
                </div>
                <div class="row">
                    <div class="col-md-6 services-2 w-100 d-flex">
                        ...
                        <div class="text pl-3">
                            <h4>Justification</h4>
                            <p>As a web development team, we recognize the significance of creating a website in fostering trust and engagement with clients.</p>
                        </div>
                    </div>
                    <div class="col-md-6 services-2 w-100 d-flex">
