    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-end">
        <div class="col-md-9 ftco-animate pb-5">
          <p class="breadcrumbs mb-2"><span class="mr-2"><a href="../welcome.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>My Account <i class="ion-ios-arrow-forward"></i></span></p>
        ...
        <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
          <div class="d-block services text-center">
            ...
            <div class="media-body p-4">
              ...
              <p>Find all the login information, access your personal information, and more.</p>
              <a href="./account_details.php" class="btn-custom d-flex align-items-center justify-content-center"><span class="fa fa-chevron-right"></span><i class="sr-only">Leer más</i></a>
            </div>
          </div>
        </div>
        <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
          <div class="d-block services text-center">
            ...
            <div class="media-body p-4">
              <h3 class="heading">My pets</h3>
              <p>Access the information of your registered pets whenever you want.</p>
              <a href="./pets.php" class="btn-custom d-flex align-items-center justify-content-center"><span class="fa fa-chevron-right"></span><i class="sr-only">Leer más</i></a>
            </div>
          </div>
        </div>
        <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
          <div class="d-block services text-center">
            ...
            <div class="media-body p-4">
              <h3 class="heading">Make an appointment</h3>
              <p>Make an appointment so we can help/attend your pet.</p>
              <a href="./appointments.php" class="btn-custom d-flex align-items-center justify-content-center"><span class="fa fa-chevron-right"></span><i class="sr-only">Leer más</i></a>
            </div>
          </div>
        </div>
      </div>
