            ...
            <div class="row mb-5">
              <div class="col-md-3">
                <div class="dbox w-100 text-center">
                  ...
                  <div class="text">
                    <p><span>Dirección:</span>	Av. Antonio de Deza Y Ulloa 210, San Felipe I Etapa, 31203 Chihuahua, Chih. México</p>
                  </div>
                </div>
              </div>
              <div class="col-md-3">
                <div class="dbox w-100 text-center">
                  ...
                  <div class="text">
                    <p><span>Teléfono:</span> <a href="tel://1234567920">+ 52-614-413-1002</a></p>
                  </div>
                </div>
              </div>
              <div class="col-md-3">
                <div class="dbox w-100 text-center">
                  ...
                  <div class="text">
                    <p><span>Correo electrónico:</span> <a href="mailto:info@yoursite.com">pawsomemks@gmail.com</a></p>
                  </div>
                </div>
              </div>
              <div class="col-md-3">
                <div class="dbox w-100 text-center">
                  ...
                  <div class="text">
                    <p><span>Inicio</span> <a href="../index.php">Pawsome Makeovers</a></p>
                  </div>
                </div>
              </div>
            </div>
