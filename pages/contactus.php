    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-end">
        <div class="col-md-9 ftco-animate pb-5">
          <p class="breadcrumbs mb-2"><span class="mr-2"><a href="../welcome.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Contact Us<i class="ion-ios-arrow-forward"></i></span></p>
            ...
            <div class="row mb-5">
              <div class="col-md-3">
                <div class="dbox w-100 text-center">
                  ...
                  <div class="text">
                    <p><span>Address:</span>	Av. Antonio de Deza Y Ulloa 210, San Felipe I Etapa, 31203 Chihuahua, Chih. México</p>
                  </div>
                </div>
              </div>
              <div class="col-md-3">
                <div class="dbox w-100 text-center">
                  ...
                  <div class="text">
                    <p><span>Phone:</span> <a href="tel://1234567920">+ 52-614-413-1002</a></p>
                  </div>
                </div>
              </div>
              <div class="col-md-3">
                <div class="dbox w-100 text-center">
                  ...
                  <div class="text">
                    <p><span>Email:</span> <a href="mailto:info@yoursite.com">pawsomemks@gmail.com</a></p>
                  </div>
                </div>
              </div>
              <div class="col-md-3">
                <div class="dbox w-100 text-center">
                  ...
                  <div class="text">
                    <p><span>Website</span> <a href="../index.php">Pawsome Makeovers</a></p>
                  </div>
                </div>
              </div>
            </div>
