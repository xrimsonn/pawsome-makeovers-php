        ...
        <form class="card ftco-animate" method="post" id="formularioEdicion" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
          <div class="card-body p-5">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control rounded-input" placeholder="Nombre" id="nombre" name="nombre" value="<?php echo $nombre; ?>" required>
            </div>

            <div class="row">
              <div class="col-md-6 mb-3">
                <input type="number" class="form-control rounded-input" placeholder="Edad (años)" id="edad" name="edad" value="<?php echo $edad; ?>" min="0" max="25" required>
              </div>
              <div class="col-md-6 mb-3">
            ...
            <div class="mb-3">
              <input type="text" class="form-control rounded-input" placeholder="Raza" id="raza" name="raza" value="<?php echo $raza; ?>" required>
            </div>

            <div class="mb-3">
              <select class="form-control rounded-input" id="genero" name="genero" required>
                <option disabled>Género</option>
                <option value="1" <?php if ($genero === 1) echo "selected"; ?>>Macho</option>
                <option value="0" <?php if ($genero === 0) echo "selected"; ?>>Hembra</option>
              </select>
            </div>
            ...
            <div class="d-flex justify-content-center">
              <button type="submit" class="btn btn-primary rounded-input" id="boton" style="width: 75%; height: 45px;">Guardar Cambios</button>
            </div>
