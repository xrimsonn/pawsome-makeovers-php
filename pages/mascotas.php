...
<body>
    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-end">
        <div class="col-md-9 ftco-animate pb-5">
          <p class="breadcrumbs mb-2"><span class="mr-2"><a href="../index.php">Inicio <i class="ion-ios-arrow-forward"></i></a></span> <span>Mis mascotas <i class="ion-ios-arrow-forward"></i></span></p>
          <h1 class="mb-0 bread">Mis Mascotas</h1>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="ftco-section bg-light pb-5 pt-5">
      ...
      <div class="block-7">
        <div class="p-4">
          <span class="text-left excerpt d-block pt-1 pb-3">
            <h3>Lista de mis mascotas</h3>
          </span>
          <ul class="text-center pricing-text mb-5 list-unstyled">
            ...
            ?>
                ...
                <li class="pb-1" style="list-style: none !important;">
                  ...
                  <div class="collapse hide" id="collapse-<?php echo $nombre; ?>" role="tabpanel" aria-labelledby="heading-<?php echo $nombre; ?>">
                    <div class="py-3 px-0">
                      ...
                      <h3 class="text-left ml-5"><b>Datos</b></h3>
                      <div class="row justify-content-left text-left ml-5 mr-5 mb-5">
                        <div class="col-md-3">
                          <h5><b>Especie: </b><?php echo $especie; ?></h5>
                          <h5><b>Raza: </b><?php echo $raza; ?></h5>
                        </div>
                        <div class="col-md-3">
                          <h5><b>Edad: </b><?php echo $edad; ?></h5>
                          <?php if ($sexo == 1) { ?>
                            <h5><b>Sexo: </b>Macho</h5>
                          <?php } else { ?>
                            <h5><b>Sexo: </b>Hembra</h5>
                          <?php } ?>
                        </div>
                      </div>

                      <h3 class="text-left ml-5"><b>Citas</b></h3>
                      <div class="justify-content-left">
                        ...
                        ?>
                            <div class="row justify-content-center mb-5 ml-5 mr-5 text-left">
                              <div class="col-md-3">
                                <h5><b>ID de Ticket: </b><?php echo $id_cita; ?></h5>
                                <h5><b>Fecha: </b><?php echo $fecha; ?></h5>
                              </div>
                              <div class="col-md-3">
                                <h5><b>Tipo: </b><?php echo $tipo; ?></h5>
                                <?php if ($hora == null) { ?>
                                  <h5><b>Hora: </b>Por definir</h5>
                                <?php } else { ?>
                                  <h5><b>Hora: </b><?php echo $hora; ?></h5>
                                <?php } ?>
                              </div>
                              <div class="col-md">
                                <h5><b>Descripcion: </b><?php echo $descripcion; ?></h5>
                          ...
                          ?>
                          <h5>Aún no hay citas disponibles</h5>
    ...
    <div class="mb-5 mt-5 d-flex justify-content-center">
      <a href="./registrarmascota.php" class="btn btn-primary rounded-input ftco-animate " id="boton">Registrar Mascota</a>
    </div>
