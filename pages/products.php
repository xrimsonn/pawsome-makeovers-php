    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-end">
        <div class="col-md-9 ftco-animate pb-5">
          <p class="breadcrumbs mb-2"><span class="mr-2"><a href="../welcome.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Products <i class="ion-ios-arrow-forward"></i></span></p>
    ...
    <?php
      ...
      <div class="col-md-4 ftco-animate">
        <div class="card mb-4">
          ...
          <div class="card-body">
            <h2 class="card-title"><a href=""><?php echo $row['type_product']; ?></a></h2>
