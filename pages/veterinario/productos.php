        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-12">
                ...
                <div class="mt-5 mb-3 clearfix">
                    <h2 class="text-center mb-4" style="color: #576ca8; font-family:inherit; font-weight:1000;"> Nuestros Productos </h2>
                    <div class="mt-5 mb-3 clearfix"> 
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo '<img src="data:image/jpeg;base64,' . base64_encode($row["foto"]) . '" alt="Imagen del producto" style="max-width: 150px; max-height: 150px; border-radius:5px;">';
                            echo "</td>";
                            echo "<td>" . $row["descripcion"] . "</td>";
                            echo "<td>$" . $row["precio"] . "</td>";
                            echo "<td>";
                            echo '<a href="actualizarproducto.php?id=' . $row['id_productos'] . '" class="mr-3" title="Editar Producto" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                            echo '<a href="eliminarproducto.php?id=' . $row['id_productos'] . '" class="mr-3" title="Eliminar Producto" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                            echo "</td>";
                            echo "</tr>";
                        }
                        echo "</tbody>";
