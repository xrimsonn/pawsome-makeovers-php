      ...
      <div class="row justify-content-center">
        ...
        <div class="col-md-12">
          ...
          <div class="mt-5 mb-3 clearfix">
            <h2 class="text-center mb-4" style="color: #576ca8; font-family:inherit; font-weight:1000;"> Citas </h2>
            <?php
            ...
            if ($result->num_rows > 0) {
              ...
              while ($row = $result->fetch_assoc()) {
                ...
                echo "<td>" . $row["hora"] . "</td>";
                echo "<td>" . $row["realizada"] . "</td>";
                echo "<td><form action='./editarcita.php' method='get'>
                <input type='hidden' name='id' value=".$row['id_cita']." required>
                <button class='btn' type='submit'><i class='fa fa-pencil' aria-hidden='true'></i>
                </button>
              </form></td>";
                echo "</tr>";
              }
